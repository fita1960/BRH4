...
<div class="main">
    ...
    <div class="container mb-4">
        <button type="button" class="btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#newActivityModal">Add Record</button>
    </div>
        ...
        <table id="example" class="table table-striped" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo '../assets/activities/'.$row["activity_image"]; ?>" alt="..." style="width: 100px;"></td>
                        ...
                        <td><?php 
                            ...
                            echo $ft?></td>
                        <td>
                            <button type="button" class="btn-success rounded p-1" data-bs-toggle="modal" data-bs-target="#editActivity<?php echo $row['activity_id'] ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
                                    <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"></path>
                                </svg>
                            </button>
                            <a href="#" onclick="document.getElementById('deleteActivity<?php echo $row['activity_id']; ?>').submit();">
                            ...
                            <form id="deleteActivity<?php echo $row['activity_id']; ?>" action="../includes/actions.inc.php" method="post">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="newActivityModalLabel">New Activity</h5>
                ...
                <div class="modal-body">
                    <form action="../includes/actions.inc.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea required class="form-control" id="activity_description" name="activity_description" rows="8"></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="activity_image">Image:</label>
    ...
    <div class="modal fade" id="editActivity<?php echo $row['activity_id'] ?>" tabindex="-1">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../includes/actions.inc.php" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" class="form-control" id="activity_id" name="activity_id" value="<?php echo $row['activity_id']; ?>">
                        <div class="mb-3">
                            <label for="activity_name" class="form-label">Activity Name:</label>
                        ...
                        <div class="mb-3">
                            <label for="activity_description" class="form-label">Activity Description:</label>
                            <textarea class="form-control" id="activity_description" name="activity_description" rows="15" value=""><?php echo $row['activity_description']; ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="activity_image">Image:</label>
                            <input type="file" class="form-control" name="activity_image" required/>
