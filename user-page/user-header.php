    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top border-bottom">
        <div class="container">
            <div class="col-6 col-sm-4 pt-1">
              <a class="navbar-brand" href="user-index.php"><img class="logo img-fluid mb-2" src="../assets/logo-1.png" alt="RH IV Logo"></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-center" aria-current="page" href="user-requestdocument.php">Request a Document</a>
                    </li>
                    <li class="nav-item">
